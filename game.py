"""Core Cookie Clicker game: the main window, buildings, upgrades and saving."""
...
from windows import Help, Save, UpgradeInfo, FirstGold
from upgrades import (
    CursorUpgrades, GrandmaUpgrades, FarmUpgrades, MineUpgrades,
    FactoryUpgrades, BankUpgrades, TempleUpgrades, WizardTowerUpgrades,
    ShipmentUpgrades, AlchemyLabUpgrades, PortalUpgrades, TimeMachineUpgrades,
)
...
class Cookies:
    def __init__(self, parent):
        ...
        # the parent passed in is the Tk root window
        self.parent = parent
