...
class Cookies:
    def __init__(self, parent):
        ...
        self.cookie_heading = Label(self.cookie_frame, text='Click the Cookie', font='arial 24 bold', padx=20, pady=20, bg=bgcolour, fg='white')
        self.cookie_heading.grid(row=0)
        
        #upgrade frame (column1)
        self.upgradesframe = Frame(self.cookie_frame, bg=upgradebg)
        self.upgradesframe.grid(row=0, column=1, rowspan=10, padx=20, pady=10)
        
        # Cookie Amount (row1, column0)
        self.cookie_counter = Label(self.cookie_frame, text= '0 Cookies', font='arial 18', pady=10, bg=bgcolour, fg='white')
        ...
        #Help
        self.help_button = Button(self.buttonframe, text='Help', bg='#188f10', fg='white', padx=10, pady=10, command=self.help, font='arial 12 bold', activebackground='#21c716', activeforeground='white')
        ...
        #Quit
        self.quit_button = Button(self.buttonframe, text='Quit', bg='#8a1b0f', fg='white', padx=10,pady=10, command=self.quit, font='arial 12 bold', activebackground='#c42818', activeforeground='white')
        ...
        self.buildingupgradeframe.grid(row=0, rowspan=10, column=3, padx=10, pady=10)
        
        # Cookies per second 
        self.cookiespersecond = Label(self.upgradesframe, text='Buildings', font='arial 26 bold', justify=CENTER, bg=upgradebg)
        ...
        self.multiplierlabel = Label(self.buymultiplierframe, text='Buy', font='arial 14 bold', bg='#465d70', padx=10, pady=5, fg='white')
        self.multiplierlabel.grid(row=0, column=0, padx=20)
        
        self.multiplierone = Button(self.buymultiplierframe, text='x1', font= 'arial 12 bold', bg='#465d70', highlightthickness = 0, bd = 0, padx=10, fg='white', activebackground='#465d70', activeforeground='white', command=self.timesone)
        self.multiplierone.grid(row=0, column=1, padx=20)
        
        self.multiplierten = Button(self.buymultiplierframe, text='x10', font= 'arial 12 ', bg='#465d70', highlightthickness = 0, bd = 0, padx=10, fg='white', activebackground='#465d70', activeforeground='white', command=self.timesten)
        self.multiplierten.grid(row=0, column=2, padx=20)
        
        self.multiplierhundred = Button(self.buymultiplierframe, text='x100', font= 'arial 12 ', bg='#465d70', highlightthickness = 0, bd = 0, padx=10, fg='white', activebackground='#465d70', activeforeground='white', command=self.timeshundred)
        ...
        self.cursor_label = Label(self.upgradesframe, text='Cursor: 15 Cookies', font='arial 14', padx=20, pady=10, bg=upgradebg)
        self.cursor_label.grid(row=3,column=0, sticky=W)
        
        self.cursor_amount = Label(self.upgradesframe, text='Amount: 0', font='arial 10', padx=20, pady=10, bg=upgradebg)
        self.cursor_amount.grid(row=3, column=1)
        
        self.cursor_buy = Button(self.upgradesframe, command=lambda:[self.cursor(), self.startidletimer()], image=self.buybuttonimage, highlightthickness = 0, bd = 0, bg=upgradebg, activebackground=upgradebg, pady=10)
        ...
        self.grandma_label = Label(self.upgradesframe, text='Grandma: 100 Cookies', font='arial 14', padx=20, pady=10, bg=upgradebg)
        self.grandma_label.grid(row=4,column=0, sticky=W)
        
        self.grandma_amount = Label(self.upgradesframe, text='Amount: 0', font='arial 10', padx=20, pady=10, bg=upgradebg)
        self.grandma_amount.grid(row=4, column=1)        
        
        self.grandma_buy = Button(self.upgradesframe, command=lambda:[self.grandma(), self.startidletimer()], image=self.buybuttonimage, highlightthickness = 0, bd = 0, bg=upgradebg, activebackground=upgradebg, pady=10)
        ...
        self.farm_label = Label(self.upgradesframe, text='Farm: 1100 Cookies', font='arial 14', padx=20, pady=10, bg=upgradebg)
        self.farm_label.grid(row=5,column=0, sticky=W)
        
        self.farm_amount = Label(self.upgradesframe, text='Amount: 0', font='arial 10', padx=20, pady=10, bg=upgradebg)
        self.farm_amount.grid(row=5, column=1)        
        
        self.farm_buy = Button(self.upgradesframe, command=lambda:[self.farm(), self.startidletimer()], image=self.buybuttonimage, highlightthickness = 0, bd = 0, bg=upgradebg, activebackground=upgradebg, pady=10)
        ...
        self.mine_label = Label(self.upgradesframe, text='Mine: 12000 Cookies', font='arial 14', padx=20, pady=10, bg=upgradebg)
        self.mine_label.grid(row=6,column=0, sticky=W)
        
        self.mine_amount = Label(self.upgradesframe, text='Amount: 0', font='arial 10', padx=20, pady=10, bg=upgradebg)
        self.mine_amount.grid(row=6, column=1)        
        
        self.mine_buy = Button(self.upgradesframe, command=lambda:[self.mine(), self.startidletimer()], image=self.buybuttonimage, highlightthickness = 0, bd = 0, bg=upgradebg, activebackground=upgradebg, pady=10)
        ...
        self.factory_label = Label(self.upgradesframe, text='Factory: 130000 Cookies', font='arial 14', padx=20, pady=10, bg=upgradebg)
        self.factory_label.grid(row=7,column=0, sticky=W)
        
        self.factory_amount = Label(self.upgradesframe, text='Amount: 0', font='arial 10', padx=20, pady=10, bg=upgradebg)
        self.factory_amount.grid(row=7, column=1)        
        
        self.factory_buy = Button(self.upgradesframe, command=lambda:[self.factory(), self.startidletimer()], image=self.buybuttonimage, highlightthickness = 0, bd = 0, bg=upgradebg, activebackground=upgradebg, pady=10)
        ...
        self.cursorupgrade3 = CursorUpgrades(self, 'Ambidextrous', 10000, 10, 3, 'times', 2)
        self.cursorupgrade4 = CursorUpgrades(self, 'Thousand fingers', 100000, 25, 4, 'plus', 0.1)
            ...
            while True:
                if self.closeprogram == True:
                    ...
                    if self.closeprogram == True:
                        ...
                        self.cookie_button.configure(image=self.goldcookieimage, command=self.gold_cookie_click)
                        self.cookie_heading.configure(fg='#ffe76d', text='Click the Golden Cookie')
                        self.cookie_button.unbind("<Enter>")
                        self.cookie_button.unbind("<Leave>")
                        self.cookie_button.bind("<Enter>", self.hovergoldcookie)
                        self.cookie_button.bind("<Leave>", self.unhovergoldcookie)
                        for i in range(13): 
                            time.sleep(1)
                            if self.closeprogram == True:
                                break                          
                        if self.closeprogram == True:
                            ...
                            self.cookie_button.configure(image=self.cookieimage, command=self.cookie_click)
        ...
        self.backgroundspawngoldcookie=threading.Thread(name='spawngoldcookietimer',target=spawngoldcookie) #create threading variable
    ...
    def changecookietext(self): #Change the cookie amount label
        roundedcookies=math.floor(self.cookies) #round down as actual amount can have decimals
        try:
    ...
    def timeshundred(self): #function for x100 button, sets multiplier to 100 and updates labels
    ...
    def pricecalc(self): #calculates the prices of upgrade purchases depending on the upgrade multiplier selected
        self.cursor_price = math.ceil(self.basecursor_price *self.upgrademultiplier)
        cursorprice_text=('Cursor: {} Cookies'.format(self.numbercheck(self.cursor_price)))
        self.cursor_label.configure(text=cursorprice_text)
        
        self.grandma_price = math.ceil(self.basegrandma_price *self.upgrademultiplier)
        grandmaprice_text=('Grandma: {} Cookies'.format(self.numbercheck(self.grandma_price)))
        self.grandma_label.configure(text=grandmaprice_text)        
        
        self.farm_price = math.ceil(self.basefarm_price *self.upgrademultiplier)
        farmprice_text=('Farm: {} Cookies'.format(self.numbercheck(self.farm_price)))
        self.farm_label.configure(text=farmprice_text)        
        
        self.mine_price = math.ceil(self.basemine_price *self.upgrademultiplier)
        mineprice_text=('Mine: {} Cookies'.format(self.numbercheck(self.mine_price)))
        self.mine_label.configure(text=mineprice_text)       
        
        self.factory_price = math.ceil(self.basefactory_price *self.upgrademultiplier)
        factoryprice_text=('Factory: {} Cookies'.format(self.numbercheck(self.factory_price)))
        self.factory_label.configure(text=factoryprice_text)           
        
        self.bank_price = math.ceil(self.basebank_price *self.upgrademultiplier)
        bankprice_text=('Bank: {} Cookies'.format(self.numbercheck(self.bank_price)))
    ...
    def cursor(self): #function for buying a cursor
        if self.cursor_buyable == True:
            ...
            #Calculate new price
            self.basecursor_price = math.ceil(self.basecursor_price*1.15)
            self.cursor_price = math.ceil(self.basecursor_price + (self.basecursor_price*1.15*(self.upgrademultiplier-1)))
            
            price_text=('Cursor: {} Cookies'.format(self.numbercheck(self.cursor_price)))
            self.cursor_label.configure(text=price_text)
    ...
    def grandma(self): #function for buying a grandma
        if self.grandma_buyable == True:
            ...
            #Calculate new price
            self.basegrandma_price = math.ceil(self.basegrandma_price*1.15)
            self.grandma_price = math.ceil(self.basegrandma_price + (self.basegrandma_price*1.15*(self.upgrademultiplier-1)))
            
            price_text=('Grandma: {} Cookies'.format(self.numbercheck(self.grandma_price)))
            self.grandma_label.configure(text=price_text)
    ...
    def farm(self): #function for buying a farm
        if self.farm_buyable == True:
            ...
            #Calculate new price
            self.basefarm_price = math.ceil(self.basefarm_price*1.15)
            self.farm_price = math.ceil(self.basefarm_price + (self.basefarm_price*1.15*(self.upgrademultiplier-1)))
            
            price_text=('Farm: {} Cookies'.format(self.numbercheck(self.farm_price)))
            self.farm_label.configure(text=price_text)
    ...
    def mine(self): #function for buying a mine
        if self.mine_buyable == True:
            ...
            #Calculate new price
            self.basemine_price = math.ceil(self.basemine_price*1.15)
            self.mine_price = math.ceil(self.basemine_price + (self.basemine_price*1.15*(self.upgrademultiplier-1)))
            
            price_text=('Mine: {} Cookies'.format(self.numbercheck(self.mine_price)))
            self.mine_label.configure(text=price_text)
    ...
    def factory(self): #function for buying a factory
        if self.factory_buyable == True:
            ...
            #Calculate new price
            self.basefactory_price = math.ceil(self.basefactory_price*1.15)
            self.factory_price = math.ceil(self.basefactory_price + (self.basefactory_price*1.15*(self.upgrademultiplier-1)))
            
            price_text=('Factory: {} Cookies'.format(self.numbercheck(self.factory_price)))
            self.factory_label.configure(text=price_text)
    ...
    def bank(self): #function for buying a bank
        if self.bank_buyable == True:
            ...
            #Calculate new price
            self.basebank_price = math.ceil(self.basebank_price*1.15)
            self.bank_price = math.ceil(self.basebank_price + (self.basebank_price*1.15*(self.upgrademultiplier-1)))
            
            price_text=('Bank: {} Cookies'.format(self.numbercheck(self.bank_price)))
            self.bank_label.configure(text=price_text)
    ...
    def cpscalc(self): #calculates cps from number of upgrades owned
        self.cps = self.cursorcps*self.cursors + self.grandmacps*self.grandmas + self.farmcps*self.farms + self.minecps*self.mines + self.factorycps*self.factories + self.bankcps*self.banks
        try:
    ...
    def help(self): #help button function
        get_help = Help(self)
        get_help.help_text.configure(text="Click on the Cookie to get a cookie! Use your cookies to buy upgrades which boost your cookie production.")    
...
class Help:
    ...
    def __init__(self,partner):
        ...
        # Heading
        how_heading = Label(self.help_frame, text="Help / Info", font="arial 16 bold", bg=bg_colour, pady=10)
        how_heading.grid(row=0)
        
        # Body Text
        self.help_text = Label(self.help_frame, text="", justify=CENTER, width=40, bg=bg_colour, wrap=250, font="arial 12")
...
class CursorUpgrades:
    def __init__(self, parent, name, price, unlock, order, effectfunction, effectnumber):
        self.name = name
        self.price = price
    ...
    def buy(self, parent):
        ...
        if self.effectfunction == 'plus':
            self.totalbuildingsexceptcursors = parent.grandmas + parent.farms + parent.mines + parent.factories + parent.banks
